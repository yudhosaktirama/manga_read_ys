...
class FantasyWidget extends StatefulWidget {
  const FantasyWidget({super.key});

  @override
  State<FantasyWidget> createState() => _FantasyWidgetState();
}

class _FantasyWidgetState extends State<FantasyWidget> {
