...
class MysteryWidget extends StatefulWidget {
  const MysteryWidget({super.key});

  @override
  State<MysteryWidget> createState() => _MysteryWidgetState();
}

class _MysteryWidgetState extends State<MysteryWidget> {
