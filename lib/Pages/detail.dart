                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          image: DecorationImage(
                              image: widget.coverLandscape == null
                                  ? const NetworkImage(
                                      "https://thebiem.com/wp-content/uploads/2022/11/1.jpg")
                                  : NetworkImage(widget.coverLandscape!),
                              fit: BoxFit.fill)),
                    ),
                    Positioned(
                      bottom: 0,
                  ...
                  child: Column(
                    children: [
                      ...
                      AnimeDetailInformation(
                          param1: "Judul : ${widget.judul}",
                          param2: "Tipe : ${widget.tipe}"),
                      AnimeDetailInformation(
                          param1: "Genre : ${widget.genre}",
                          param2: "Total Episode : ${widget.episode}"),
                      AnimeDetailInformation(
                        param1: "Rank : ${widget.rank}",
                        param2: "Source : ${widget.source}",
                      ),
                      AnimeDetailInformation(
                        param1: "Durasi : ${widget.durasi}",
